...
author: "Peter K. Dunn"
date: '2026-03-30 17:18:40.364511'
knit: render_book
...
<div class='webex-radiogroup' id='radio_KJLGESISCL'><label><input type="radio" autocomplete="off" name="radio_KJLGESISCL" value=""></input> <span>The inventor of the fairy floss machine was a dentist</span></label><label><input type="radio" autocomplete="off" name="radio_KJLGESISCL" value=""></input> <span>Barack Obama has won two Grammy awards</span></label><label><input type="radio" autocomplete="off" name="radio_KJLGESISCL" value="answer"></input> <span>Once a year all of Wikipedia is printed, and placed in a vault in Norway.</span></label></div>
