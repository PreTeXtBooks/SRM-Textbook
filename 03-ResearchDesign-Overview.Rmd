...
It *may* be the case (for example) that males are more likely to walk in the rain than females, so 'whether it is raining' *may* be an confounding variable (but it is not obvious).
:::
