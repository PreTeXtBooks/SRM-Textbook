...
if (knitr::is_html_output()){
  ...
  for (i in (1:length(Wts))){
    ...
    text(  1:datagrid.x, 
           rep(4, 11), 
           format((Wts[1:11]), nsmall = 1),  
           cex = cex.data )
    text(  1:datagrid.x, 
           rep(3, 11), 
           format(Wts[12:22], nsmall = 1), 
           cex = cex.data )
    text(  1:datagrid.x, 
           rep(2, 11), 
           format(Wts[23:33], nsmall = 1), 
           cex = cex.data )
    text(  1:datagrid.x, 
           rep(1, 11), 
           format(Wts[34:44], nsmall = 1), 
           cex = cex.data )
...
```{r ShowVar, fig.cap="(ref:StdDevDemo)", fig.align="center",fig.width=8, fig.height=4.25, out.width='90%'}
source("R/showVar.R") 
...
source("R/showOutliersIQRRule.R") 
```
...
```{r WaterAcessQuant, fig.align="center", fig.cap="The age of the female household coordinator, the number of people in the household, and the number of children in the household aged under $5$ years, for the water-access study.", out.width='100%', fig.width=6.5, fig.height=2.25}

par(mfrow = c(1, 3),
    mar = c(5, 3.1, 4.1, 1.6))

hist(WaterAccess$Age,
     xlab = "Woman's age (in y)",
     ylab = "",
     main = "Age of female\nhousehold coordinator",
     ylim = c(0, 40),
     xlim = c(15, 65),
     las = 2)
title(ylab = "Number of household",
      line = 2)
...
hist(WaterAccess$HouseholdPeople,
     ...
     breaks = seq(-0.5, 34.5, 
                  by = 5))
title(ylab = "Number of households",
      line = 2)
...
```{r VariationHistograms, echo=FALSE, fig.align="center", fig.cap="Histogram of marks for four classes.", out.width='55%', fig.width=5.5, fig.height=3.85, out.width="75%"}
set.seed(2015)
...
```{r FourHistograms, echo=FALSE, fig.cap="Four histograms: where would they be useful?", fig.align="center", out.width='55%', fig.width=5.25, fig.height=3.85, out.width="75%"}
